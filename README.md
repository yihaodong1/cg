...
## 1. 作业内容
本课程作业是横跨一学期的项目，要求跟随课程进度在项目中实现各种图形学算法，最终完成一个完整的图形学系统，进度自由安排，**`3月31日`**、**`4月30日`**、**`5月31日`**提交**进度报告**和**已完成代码**，**`6月`**提交**系统报告**、**完整的系统**、**系统使用说明书**和**系统演示视频**，最后一次的具体时间时间视教学情况以及学校考试安排情况而定。
