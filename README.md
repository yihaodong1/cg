...
## 更新记录
 - \[2021/6/09 13:08\] 六月期末报告+系统提交地址已更新
...
## 1. 作业内容
本课程作业是横跨一学期的项目，要求跟随课程进度在项目中实现各种图形学算法，最终完成一个完整的图形学系统，进度自由安排，**`3月31日`**、**`4月30日`**、**`5月31日`**提交**进度报告**和**已完成代码**，**`6月底`**提交**系统报告**、**完整的系统**、**系统使用说明书**和**系统演示视频**，最后一次的具体时间时间视教学情况以及学校考试安排情况而定。
...
- 提交方式：
    ...
    >
    > 六月期终报告+系统提交地址：https://box.nju.edu.cn/u/d/6ce34b2a8d7d47a48d45/
    >
    > 查看已提交的文件：https://box.nju.edu.cn/d/4b08828dcf19457d8d9a/
    >
    > 密码：cg2021
